...
## Design
- **Aesthetic:** Apple-style — generous whitespace, large type, glassmorphism, floating dynamic cards with hover-lift + tilt, scroll-reveal animations.
- **Palette:** Ink black `#0b0b0c` + brand gold `#e6cf4b` (pulled from the original logo) on Apple-neutral whites (`#f5f5f7`).
- **Brand assets preserved:** original One Hour Title logo, WFG National Title logo, brand gold accent.
